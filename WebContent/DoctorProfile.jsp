<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
 ...
 <%
	 ...
	 if(session.getAttribute("name")==null){
		response.sendRedirect("Doctorlogin.jsp");	/*if user not loged in redirect to login page*/
	}
...
<!-- Navigation-->
	<nav
		...
		<p style="padding:15px"><a  style = "text-decoration:none" href="<%=request.getContextPath()%>/list"
									class="profileh" >View Schedules</a></p>							
	</nav><br><br><br>
			...
			<div class="container">
				...
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Doctor Profile</h2>
						...
						<form  action="#" class="register-form"
							...
							<div class="form-group">
								Specialized in:<label for="special" ></label> <input
									type="text" name="special" id="special" style="cursor:pointer" placeholder="<%=session.getAttribute("special") %>" readonly />
							</div>
							<div class="form-group">
					...
					<div class="signup-image">
						...
						<div class="form-group form-button">
								...
								<p align="center"><a  style = "text-decoration:none" href = "DoctorUpdateProfile.jsp"
									class="form-submit" >Update Profile</a></p>
									
								<br>
							
								<p align="center"><a  style = "text-decoration:none; background-color:red" href = "DeleteDoctor"
